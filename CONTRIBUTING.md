...
- Pour les mainteneurs : au moment du merge, utiliser le "Squash and merge", qui permet de masquer dans l'historique final les (parfois nombreux) commit de la PR.
