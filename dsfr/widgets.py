...
class Toggle(CheckboxInput):
    ...
    dsfr_label_attrs = {
        "data-fr-checked-label": gettext_lazy("Checked"),
        "data-fr-unchecked-label": gettext_lazy("Unchecked"),
    ...
    def __init__(
        ...
        attrs=None,
        check_test=None,
        dsfr_input_class=None,
        dsfr_label_attrs=None,
        dsfr_wrapper_class=None,
    ):
        super().__init__(attrs, check_test)
        self.dsfr_input_class = (dsfr_input_class or self.dsfr_input_class).strip()
        self.dsfr_wrapper_class = (
            dsfr_wrapper_class or self.dsfr_wrapper_class
        ).strip()
